...
@section('judul', 'Registrasi Admin')
@section('isi')
    ...
    <div class="container">
        <div class="card"> 
            <div class="card-body">
                ...
                <form action="/daftaradmin" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password2" class="form-control @error('password2') is-invalid @enderror" id="password2">
                        @error('password2')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
