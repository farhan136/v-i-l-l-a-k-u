...
Route::group(['middleware'=>'CekLogin'], function(){
	...
	Route::get('/admin/villa', 'App\Http\Controllers\AdminsController@tampilkanvilla');

	Route::get('/admin/pemesanan', 'App\Http\Controllers\AdminsController@transaksi');
	Route::get('/admin/detailtransaksi/{id}', 'App\Http\Controllers\AdminsController@detailtransaksi');
	...
	Route::get('/detail/{id}', 'App\Http\Controllers\AdminsController@detail');
	
	Route::group(['middleware'=>'CekLoginAdmin:ADMIN'], function(){ 
	...
	Route::group(['middleware'=>'CekLoginAdmin:OWNER'], function(){ 
		...
		Route::post('tambah', 'App\Http\Controllers\AdminsController@store');
	});
